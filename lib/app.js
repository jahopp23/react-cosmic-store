...
const credentials = {
  bucket: {
    ...
    read_key: process.env.COSMIC_READ_KEY || 'A6hwJLMs07UoQfhXveOgf7X2wakdc8h7xrDRAGEntLM0vkd1w1',
    write_key: process.env.COSMIC_WRITE_KEY || 'GFljrCW01xVT18esxFbRtuYyMUtBXASVf7Iff8VyzyT8k0otyU',
  }
}
