...
const credentials = {
  bucket: {
    ...
    read_key: process.env.COSMIC_READ_KEY || '5xw2oAUuRCOgY9NBExIgRxrUGMzqsgy5ufvNuSbhuPrd2XvjCr',
    write_key: process.env.COSMIC_WRITE_KEY || 'JqXalnYKc1undXw86UQEjTE69D6OPyTTycy7atvN5sqn15ARLL',
  }
}
